...
After not finding any edge with the normal z-score outlier detection I decided to implement a new outlier detection logic.

starting of by loading data 
...
Since I want to be able to do walk forward analysis I defined a function which returns the file path of the data for different timespans.

\textbf{core outlier detection using IQR Method}
\begin{verbatim}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{imgs/IQR_method.png}
  \caption{IQR method}
