...
So this strategy was first time I tested on a simple logic. If the trend indentification showed that we are in an uptrend and a bullish outlier was detected we would enter a position a buy position.
...
\begin{equation}
  \Delta_t > \mu(\Delta) + 2\sigma(\Delta) \quad \text{and} \quad \text{trend} = 'Uptrend'
\end{equation}
