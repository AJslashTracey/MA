...
\section{Orderbook Delta defenition}
...
This idea was developed from a friend of mine who suggested I should check for direction pressure in combination with a z-score based outlier detection.
A direction pressure is a measure of the strength of the buy or sell pressure in the orderbook. 
...
So this was the second strategy I tested and the first I tested with my new edge development frame work.
The logic is very straight forward with two conditions:
...
Twitter articles about random walk theory and how to test if a strategy is random or not. 
